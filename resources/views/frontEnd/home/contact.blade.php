        ...
        <div class="col-md-9">
            <div class="maincontent-left">
                ...
                <div class="content-box nativeEditor">
                    ...
                    <br/>
                    <br/>
                    <p>Digpait Shamsul Haque Degree College</p>
                    <p>Digpait,Jamalpur, Bangladesh.</p>
                    <p>Telephone: +880-1712864167</p>
                    <p>E-mail: info@digshumdc.edu.bd</p>
                    <p>Website: <a href="{{url('/')}}">www.digshumdc.edu.bd</a></p>
