    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>কৃতী শিক্ষার্থীদের  ছবি <small>সংযুক্ত করুন</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="product-image">  ছবি সংযুক্ত করুন <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
